...
public class GamePanel extends JPanel implements ActionListener {
    ...
    static final int appleDELAY = 1000;
    ...
    int appleX;
    int appleY;
    int xAppleVelocity = 1;
    int yAppleVelocity = 1;
    char direction = 'R';
    ...
    public void startGame() {
        ...
        appleTimer = new Timer(appleDELAY, this);
        timer.start();
    }
    ...
    public void appleMove() {
        appleX += (UNIT_SIZE * xAppleVelocity);
        appleY += (yAppleVelocity * UNIT_SIZE);
        if (appleY <= 0) {
            yAppleVelocity = 1;
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (running && e.getSource() == timer) {
            move();
            checkApple();
            checkCollisions();
        }
        if (running && e.getSource() == appleTimer) {
